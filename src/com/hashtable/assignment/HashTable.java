//Problems1 --> Ability to find frequency of words in a sentence i.e “To be or not to be”.
...
public class HashTable {
    ...
    public static void createHashTable(String sentence, HashTable hashTable)
    {
        /*
